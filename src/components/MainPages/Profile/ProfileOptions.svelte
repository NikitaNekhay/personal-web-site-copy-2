...
<div class="px-6 sm:px-0">
  <div
    class="grid items-center justify-items-between grid-cols-3 sm:grid-cols-2 md:grid-cols-2"
  >
    <div class="w-[100%]">
      ...
      <div class="grid justify-items-center">
        ...
        {:else}
          ...
          <div
            ...
            out:fade
            class="absolute z-0 md:mr-[50%] md:w-52 sm:right-8 sm:left-8
          ...
          >
            ...
            >
              <div class="p-2 border-1 shadow-white-2 shadow text-left">
                <a
                  href="{base}/profile"
                  class="group text-gray-700 flex px-4 py-2 text-sm
                ...
                >
                  <img
                    class="mr-2 group-hover:text-yellow-0"
                    src="{base}/media/user.svg"
                    alt="user icon"
                  />
                  <p class="self-center group-hover:text-yellow-0">
                    {$t("View")}
                  </p>
                </a>
                <a
                  href="{base}/profile/edit"
                  class="flex text-gray-700 px-4 py-2 text-sm
                ...
                >
                  <img
                    class="mr-2 group-hover:text-yellow-0 stroke-current"
                    src="{base}/media/user-edit.svg"
                    alt="user edit icon"
                  />
                  <p class="self-center group-hover:text-yellow-0">
                    {$t("Edit")}
                ...
                <a
                  href="{base}/profile/edit/credentials"
                  class="flex text-gray-700 px-4 py-2 text-sm
                      transition duration-300 delay-100 group"
                  role="menuitem"
                  tabindex="-1"
