<script lang="ts">
    ...
    // async function calculateDesktopImages(){
    //     images.forEach((object,index)=>{
    //         desktopImages[index].src = object;
    //         desktopImages[index].src =
    //     })
    // }
...
<style>
    /* @media (max-width: 1023px) {
        ...
        .image-container {
            @apply grid grid-flow-row grid-cols-1;
        }
    }
...
<!-- <div class="">
        ...
        <div id="img2" class=" mt-60">
            ...
            alt="red thing"
            title="red thing" 
            data-anchor-target="#img2">
        </div>
        <div class="flex">
            <div id="img3" class=" left-38">
                <img src="https://lh3.googleusercontent.com/ppxlqw4aPZCO3livRhql5im9ZOSa2vhsFnt77RKhtqmxB4VQ3tBDgNnBXAv5gtiWalWEXB7gd78AfgfnuMW-79YG-hupQCdCi5m_RutrDJVvpVl35cvAMI7HjQrLICb5bpy4aGRKBA=w2400",  
                alt="big yellow hand 1"
                title="big yellow hand 1" 
                data-anchor-target="#img3" 
                class="  h-5/6 w-3/6">
            </div>
            <div id="img4"  class=" justify-start">
                <img src="https://lh3.googleusercontent.com/f8Kww7LpBp_j18kc4AKBbJBlZ3s__Sgbuwlg9QBaDi1IjkL_FBGVo7sp_soxiIkP5hvP_ODZiKGuv6ft-T60r4ZMsqJbPwAmv9UcvBDsU2b-rqroGoD64OL2Ft-z1yWmsYwntgX7Ww=w2400",  
                alt="big yellow hand 2"
                title="big yellow hand 2" 
                data-anchor-target="#img4" 
                class="absolute h-6/6 w-2/6 -left-18 right-20">
            </div>
        </div>
        <div class="flex">
            <div id="img5" class="">
                <img src="https://lh3.googleusercontent.com/e677my93QSVa8O2maHeNjSqthiwAwicktjM_t5Yw1Py-FvRGT9-RppNeItKmwje1f7niebEs8EpOHsiPzJQzdUFEHh-EgVOoKeKYbC_fH411imWtRjzk78YuBSVdnpVXL0-kDbyPpQ=w2400",  
                alt="nikita in yellow lights and flowers"
                title="nikita in yellow lights and flowers" 
            data-anchor-target="#img5" 
                class="h-6/6 w-4/6">
            </div>
            <div id="img6" class="relative">
                <img src="https://lh3.googleusercontent.com/m0Jhld_-hf58mrFQfA4j0UKoNf1J-4aKUR2emepAzCfhQFqKskIUqE7s_UDZ5jgP5TdmBiz-1JxXNHeNjfYU6ywjiXm9zSJeXTFWOxRpCqm6Up7VJkljXRTpxAZZ8m2t40qfwDNFwg=w2400",  
                alt="museum of tatar history"
                title="museum of tatar history" 
                data-anchor-target="#img6" 
                class="">
            </div>
            <div id="img7" class="relative">
                <img src="https://lh3.googleusercontent.com/cL05xR42SPsTKQViH4RLmKq6fr1VMybkDkyKMnfqjeeLrUErA7YbA-bmVfXSP8Ih5hi6mWfkt9SKZzLurm_KT6U7wFUEyOKKjKHPv4jo5gEUjGhohfjfsfvNQ6_FsAILGJmZUYJh6Q=w2400",  
                alt="blurred girl with pink flower 1"
                title="blurred girl with pink flower 1" 
                data-anchor-target="#img7" 
                class="h-5/6 w-5/6">
            </div>
        </div>
        ...
        <div id="img8" class="relative"  in:fade>
            ...
            alt="table sheet"
            title="table sheet" 
            data-anchor-target="#img8" 
            class="h-5/6 w-4/6">
        </div>
        <div class="flex">
            <div id="img9" class="relative">
                <img src="https://lh3.googleusercontent.com/WB1sEI8GLvUO2x6JPgh7gPEs_tfHQxVLv-7QQF2FP3rDeEGtWlXS9M-O5h0qvhzfeUSxJO6AicrsasRsAlHmVasfw2coqtst6f3M3Ckw917cWBWCLl5L2Jplc3iZQ_xV6pOxOocekA=w2400",  
                alt="eyes behind glass"
                title="eyes behind glass" 
                data-anchor-target="#img9" 
                class="h-6/6 w-6/6">
            </div>
            <div id="img10" class="relative">
                <img src="https://lh3.googleusercontent.com/pAvVxX8R1De4iInq_qIRLM-Jq88FdanvpUbKqk8lp2jzD4ekJcOgJcnsEeoXN4FjSs-x4PmhenY_7gOp_VRYAQlMXRmJe9enHeemSE-Ewjlonq2iw3vr0LqrPt7qUFBKIAPvPrEamw=w2400",  
                alt="girl by mc"
                title="girl by mc" 
                data-anchor-target="#img10" 
                class="h-5/6 w-4/6">
            </div>
        </div>

        <div id="img11" class="relative">
            <img src="https://lh3.googleusercontent.com/z3Ic-X2IfPL1Sj-OURSgX4ADvv_VrgI8-mLpaNfdOk6e8b4ONsZfsw6xUORQpiZloQIgcoXdy3NzjG_voW890fe-Mb9F5xVo_EITy16488Qa8lzfggpoVgsArtn-UED3IA5onZGBjg=w2400",  
            alt="self portrait at market"
            title="self portrait at market" 
            data-anchor-target="#img11" 
            class="h-5/6 w-4/6">
        </div>
        <div class="flex">
            <div id="img12" class="relative">
                <img src="https://lh3.googleusercontent.com/pw/AJFCJaWjocweHIihrsfw4C8H29PuI6gnQKiZjDiJs29nuugc5wHAMAPusTIMZFbGM5xJQGrNv9Vaw6zqX_wfPfkbmFkBkk3mfzTnuei-Ytma7tN37XjppG0=w2400",  
                alt="girl linses with pink flower 1"
                title="girl linses with pink flower 1" 
                data-anchor-target="#img12" 
                class="h-5/6 w-4/6">
            </div>
            <div id="img13" class="relative">
                <img src="https://lh3.googleusercontent.com/pw/AJFCJaVuNPmnbPOYeKKoyfnSsPGKcVHCBIzGZ4PLq02W-hI0nGnUbNhXJam5Zd7w0DWMJTnpw9DVNQg-F6Yzf_i4tyxhVGfSPqZFGZJsAPF0Gmek4KeOpVU=w2400",  
                alt="strange polar bear and profile chanel"
                title="strange polar bear and profile chanel" 
                data-anchor-target="#img13" 
                class="h-5/6 w-4/6">
            </div>
            <div id="img14" class="relative">
                <img src="https://lh3.googleusercontent.com/pw/AJFCJaURjiNamjCTHVOEFGPxvGZ544xQeBuhyJbneU1E9kYvF0anAFkgS226XfzQwU7ZUzn6yf2M4UPpQxifjUNy2lgj5TYdhYK1uKlUXsQUnS9fTdYAVF0=w2400",  
                alt="blurred doctor"
                title="blurred doctor" 
                data-anchor-target="#img14" 
                class="h-5/6 w-4/6">
            </div>
        </div>
    
        <div id="img15" class="relative">
            <img src="https://lh3.googleusercontent.com/pw/AJFCJaWlHzmJorVGedZDwM_Q3ixFGbulnPLUd9Y3vFSS7PEDIdN2WsDkcvHFB2SU6QyWvxZXuxtAN8ejrjPFKN_mgMXmg4ssc95isKbS-oYV2odnXHtdw5Y=w2400",  
            alt="robot in the dark 1"
            title="robot in the dark 1" 
            data-anchor-target="#img15" 
            class="h-5/6 w-4/6">
        </div>
        <div id="img16" class="relative">
            <img src="https://lh3.googleusercontent.com/pw/AJFCJaUoUeU7N_HYucLo1KT-_BjZ_FZBHcfFpW2lX6M0hJgBV3MxYC524oeTDKcrpd37Jpeh_1PVDgmkXsTT2LYKHBAO25flWHVHejSqvTRp9CpF3kR0Qjs=w2400",  
            alt="auto portait shade on asphalt"
            title="auto portait shade on asphalt" 
            data-anchor-target="#img16" 
            class="h-5/6 w-4/6">
        </div>
        <div id="img17" class="relative">
            <img src="https://lh3.googleusercontent.com/pw/AJFCJaWayYx4nmDbir27hVxczQf5GbjywQFLQKzZ_DS6y7uSfvEx5rCSOKsWSQTmaihndf0nvBCvV8eIovM7f8OXabSqvvkzqPW1M2XqaSuyDDEHJOZhOp0=w2400",  
            alt="pipe in the sky"
            title="pipe in the sky" 
            data-anchor-target="#img17" 
            class="h-5/6 w-4/6">
        </div>
        <div id="img18" class="relative">
            <img src="https://lh3.googleusercontent.com/pw/AJFCJaX2ik2yG92gDkAvm6sRvM3V78aXWhQyuqqXlZ0oLUdduE2QUivItlH__zVe6mH5XHbK007OTSVnU8Mtx-0OfBiOkIqedJXkEJJJqC1rwd0vYJVh50g=w2400",  
            alt="september 1 flowers"
            title="september 1 flowers" 
            data-anchor-target="#img18" 
            class="h-5/6 w-4/6">
        </div>
        <div class="flex">
            <div id="img19" class="relative">
                <img src="https://lh3.googleusercontent.com/pw/AJFCJaV9b6SeRjiqc0-8nRqysYYhCNYT5LS8lBF28FquIBhgFrTjPN8p9w7UuPctBwuwpLZaQyXzANGFaW4weTkuXE4tfS5WUYOPr6haFQ-7C0uVoR1w9r4=w2400",  
                alt="ping girl 1"
                title="ping girl 1" 
                data-anchor-target="#img19" 
                class="h-5/6 w-4/6">
            </div>
            <div id="img20" class="relative">
                <img src="https://lh3.googleusercontent.com/pw/AJFCJaWQBgpguW-5w8mVEHXKVSCODsxBKgEFIsDbhGRojYapor0Fpgd5WH6JDF_4hH9OwyWjiLCdqAOzaUUw3gPw_1P13cvChwTaXvD25uK5syenFauoqFw=w2400",  
                alt="ping girl 2"
                title="ping girl 2" 
                data-anchor-target="#img20" 
                class="h-5/6 w-4/6">
            </div>
            <div id="img21" class="relative">
                <img src="https://lh3.googleusercontent.com/pw/AJFCJaWWDQX9c5AsFeb4zxcehmsOQPY3CqLVm6I4IeXkFYWOzAnQbVAEviaOrwV2XqaiZ2hNtmDQs0RtteX7PrHxs8pYxpkkJE1P35YY8aCheW5StYneJDU=w2400",  
                alt="ping girl 3"
                title="ping girl 3" 
                data-anchor-target="#img21" 
                class="h-5/6 w-4/6">
            </div>
        
        </div>
        <div class="flex">
            <div id="img22" class="relative">
                <img src="https://lh3.googleusercontent.com/pw/AJFCJaWrsmj4CE5alfVSgJVx_mG2aRr7PW2pLf33x9tO1E0oeLkQ0L1tQzqYSk1umJ7XCpoznrzm0LwZbpXembhpqpjSMODaPC6kgWG-pS0WEg_f2pEC1Cs=w2400",  
                alt="dog shadow"
                title="dog shadow" 
                data-anchor-target="#img22" 
                class="h-5/6 w-4/6">
            </div>
            <div id="img23" class="relative">
                <img src="https://lh3.googleusercontent.com/pw/AJFCJaU5lOStx4RfoAo9yyrPF11cNP8sfG53ATV5Gis4Mu1rQTX2Fg1utnOERTZir79ImH66EkCCI9t1IDM8JGUl5uUwgE5KppEGUV9U7OKUNkbn0Pqjefs=w2400",  
                alt="circle at urama"
                title="circle at urama" 
                data-anchor-target="#img23" 
                class="h-5/6 w-4/6">
            </div>
        </div>
        <div class="flex">
            <div id="img24" class="relative">
                <img src="https://lh3.googleusercontent.com/pw/AJFCJaWmegQ9fhX6uHnlPNbLa0yHgSKwhPV9KovXvCpJdykOH1mbIjl3EHOFBT4qWybxgis3VCEkjIRkV8SJtenV0iSGUFW0RJqXVv3Q40Cx-gkqeMtvc-M=w2400",  
                alt="suumbike tower"
                title="suumbike tower" 
                data-anchor-target="#img24" 
                class="h-5/6 w-4/6">
            </div>
            <div id="img25" class="relative">
                <img src="https://lh3.googleusercontent.com/pw/AJFCJaUmY4F2M5l7-WZvLdVEuO-2gHyAnl3i2jt96jwhEcXSuTr9SSZImWtp4TFwYSlTY4VVwUSG9Db6Q6eSdG4123jHy25n4KMR69dYGJxA7fKK2ZIFkQg=w2400",  
                alt="red flowers"
                title="red flowers" 
                data-anchor-target="#img25" 
                class="h-5/6 w-4/6">
            </div>
            <div id="img26" class="relative">
                <img src="https://lh3.googleusercontent.com/pw/AJFCJaVJsfMhdJjwR9oj_qSs0yNaAmH54H8HHshk-hiTs0drGw6FrmN66OY6Y5VszSIjVvSM2xbwmYJw7kS7bqBfPQ-OB9yYy292MJxxm9YF2cioJ8WS7HQ=w2400",  
                alt="red top back"
                title="red top back" 
                data-anchor-target="#img26" 
                class="h-5/6 w-4/6">
            </div>
        </div>
        <div class="flex">
            <div id="img27" class="relative">
                <img src="https://lh3.googleusercontent.com/pw/AJFCJaV8StwlRK0HazZSCHmtFlKMQacBXWdUn9fA19Z2S6xys5m9MDiI8qd0Z6DIYwEYIBsShi0zv5f03qvSvvRMo2qimKG_sH017-tV_QpiSLteydxSHgU=w2400",  
                alt="self portrait in red and brown"
                title="self portrait in red and brown" 
                data-anchor-target="#img27" 
                class="h-5/6 w-4/6">
            </div>
            <div id="img28" class="relative">
                <img src="https://lh3.googleusercontent.com/pw/AJFCJaVBSnNqUPGaCPYqJ7Coq0ySWNt8w6BrwvlLjQam01S-iYGewFuK6iANGDnL9G7DgjaJrO_aRwQZdQ9Ca5I9EdhuAgNszSz-c2gc7JMyKBGqA_itmQE=w2400",  
                alt="blurred dark orange flowers"
                title="blurred dark orange flowers" 
                data-anchor-target="#img28" 
                class="">
            </div>
        </div>
        <div class="flex">
            <div id="img29" class="relative">
                <img src="https://lh3.googleusercontent.com/pw/AJFCJaUdjLqUZ9AqTYpLE94z3WsM9b89ja4bdATrilYTZ60p0W7iISgUREODYo8QGQTpL0b6bLkAlvlzycqXSXSmhL8OYlKWlXm2Ma79eYnHgFsDeSuvTLQ=w2400",  
                alt="dark bright orange flowers"
                title="dark bright orange flowers" 
                data-anchor-target="#img29" 
                class="">
            </div>
            
            <div id="img30" class="relative">
                <img src="https://lh3.googleusercontent.com/pw/AJFCJaUdjLqUZ9AqTYpLE94z3WsM9b89ja4bdATrilYTZ60p0W7iISgUREODYo8QGQTpL0b6bLkAlvlzycqXSXSmhL8OYlKWlXm2Ma79eYnHgFsDeSuvTLQ=w2400",  
                alt="orange flowers 1"
                title="orange flowers 1" 
                data-anchor-target="#img30" 
                class="">
            </div>
            <div id="img31" class="relative">
                <img src="https://lh3.googleusercontent.com/pw/AJFCJaXU8aHdp70z9h3AghQ0Rp6tknchUdTPYgiWuN94YT1aHhNnAz-DOaNG0FXaUO5gCEBGZwWUVqkyoQgkudzUOq3urHD80DJYClG2oF7PTIlLeiNSqe0=w2400",  
                alt="orange flowers 2"
                title="orange flowers 2" 
                data-anchor-target="#img31" 
                class="">
            </div>
        
        </div>
        <div class="flex">
            <div id="img32" class="relative">
                <img src="https://lh3.googleusercontent.com/vpNWtB3ZIXObJaLdDmQAr8u9xbLxBSdo6j8HPk6VqpmXfqU7uXTeh1MWdqpx2BmP4uRYKcS085SFXVM0d0Tk7dyO9wKDV0COIoENxpph2LjIQ82ZIP59JwLsAGyGydRZ_J5nAFd_Kw=w2400",  
                alt="orange flowers 3"
                title="orange flowers 3" 
                data-anchor-target="#img32" 
                class="">
            </div>
            <div id="img33" class="relative">
                <img src="https://lh3.googleusercontent.com/4KVxPRZ5qzrHXjwlVsltS7yZIHnfveZel5pzkyr91mDL0PsYpuuIKaJaqPocWqaowx5oGHYxM7mNi8C7OEC53lpDhURbKebJeqMxEmtisMWELSRdZdz-MgfadoY8yipji3ndzORolg=w2400",  
                alt="orange triangle 1"
                title="orange triangle 1" 
                data-anchor-target="#img33" 
                class="">
            </div>
            <div id="img34" class="relative">
                <img src="https://lh3.googleusercontent.com/IKwGZPi7IOxzBKqzLnR8xt0nvNQ50tNzOXiEe6GauhgYG-3tFkEDd49QZFWib0ZjiG_KI4VsCzkiM4Rzudsv8IBrumk-Wm23onG0P1h-w6_osoC2ffN21cD_BpKF60D_kDdoxKeK-A=w2400",  
                alt="orange triangle 2"
                title="orange triangle 2" 
                data-anchor-target="#img34" 
                class="">
            </div>
        </div>
        <div id="img35" class="relative">
            <img src="https://lh3.googleusercontent.com/BvvT22SL03nEQ9kArqHXfrwRd-tx6VvDQDYP7CyU2-hSrlsBLMycwqEd8x_HWFd2P2H2PIGve6_AlHSwTtT7cfZYiPo9onlMZ9Mu9ivjGKo2ZXuk2rXWW5hzRTYU2T06lY-T6fO7nw=w2400",  
            alt="nefrite collonnades"
            title="nefrite collonnades" 
            data-anchor-target="#img35" 
            class="">
        </div>
