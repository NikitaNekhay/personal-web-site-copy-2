        ...
        <div class="px-4 sm:px-4 md:px-6 lg:px-8 2xl:px-16 3xl:px-16
            ...
            <div>
                ...
                <li class="">
                    ...
                    <span class="sr-only">Telegram</span>
                        ...
                        <svg class="" xmlns="http://www.w3.org/2000/svg" width="27" height="27"
                        viewBox="0 0 66 66">
            ...
            sm:grid-cols-2 md:grid-cols-2 xl:grid-cols-2 2xl:grid-cols-2 3xl:grid-cols-2  3xl:">
                ...
                <nav aria-label="Footer Navigation - Services" class="mt-6">
                    ...
                    <li>
                        <a href="https://www.behance.net/nekhaynikita" target="_blank" class="text-black-0 transition duration-300 delay-100 hover:text-yellow-0">
                            {$t('Photography')} 
                        </a>
                    </li>
                    </ul>
                ...
                <nav aria-label="Footer Navigation - Company" class="mt-6">
                    <ul class="space-y-4 text-sm">
                    <li>
                        <a href="{base}/about" class="text-black-0 transition duration-300 delay-100 hover:text-yellow-0">
                           {$t('About')} 
                        </a>
                    </li>
                    <li>
