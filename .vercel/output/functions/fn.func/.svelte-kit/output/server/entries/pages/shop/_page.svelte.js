...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `<!-- HEAD_svelte-1f7zle2_START -->${$$result.title = `<title>${escape("Shop")}</title>`, ""}<meta name="shop" content="clothes, books, and products"><!-- HEAD_svelte-1f7zle2_END -->`, ""}
