...
const PostCreate = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_t();
  return `<div class="flex pt-60 place-content-center place"><form class="w-full max-w-lg "><div class="flex justify-center mb-6"><h1 class="text-blue-0 text-4xl font-abril">${escape($t("CREATE POST"))}</h1></div>
