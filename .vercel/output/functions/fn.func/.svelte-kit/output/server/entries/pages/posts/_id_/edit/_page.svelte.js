import { c as create_ssr_component, j as setContext, g as getContext, s as subscribe, k as onDestroy, l as is_promise, n as noop, v as validate_component, m as missing_component, e as escape, b as add_attribute } from "../../../../../chunks/index.js";
...
const PostEdit = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.post === void 0 && $$bindings.post && post !== void 0)
    $$bindings.post(post);
  $$unsubscribe_t();
  return `<div class="place flex place-content-center pt-60"><form class="w-full max-w-lg"><div class="mb-6 flex justify-center"><h1 class="font-abril text-4xl text-blue-0">${escape($t("EDIT POST"))}</h1></div>
    ...
    <div class="-mx-3 mb-2 ms-0 flex flex-wrap"><div class="mb-6 w-2/5"><label class="relative block overflow-hidden rounded-md border border-gray-200 bg-white-1 px-3 pt-3 shadow-sm focus-within:border-white-2 focus-within:ring-1 focus-within:ring-white-2" for="price"><input class="peer h-8 w-full border-none bg-transparent bg-white-1 p-0 placeholder-transparent focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm" type="text" id="price" placeholder="400$" required${add_attribute("value", tempPost.price, 0)}>
      ...
      <div class="mb-3 h-1/2 px-3 md:mb-3 md:w-3/5"><label class="relative block overflow-hidden rounded-md border border-gray-200 bg-white-1 px-3 pt-3 shadow-sm focus-within:border-white-2 focus-within:ring-1 focus-within:ring-white-2" for="files"><input class="transparent peer block h-8 w-full border-none bg-transparent bg-white-1 p-0 text-center placeholder-transparent focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm" type="file" id="images" multiple placeholder="Files">
          <span class="absolute start-3 top-3 -translate-y-1/2 cursor-text bg-white-1 text-xs text-gray-700 transition-all peer-placeholder-shown:top-1/2 peer-placeholder-shown:text-sm peer-focus:top-3 peer-focus:text-xs"></span></label>
        ${`<p class="mt-3 text-xs italic text-gray-600">${escape($t("Quantity of images"))}:${escape(tempPost.images.length)}</p>`}</div></div>
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  $$unsubscribe_page();
  return `${$$result.head += `<!-- HEAD_svelte-zzyrst_START -->${$$result.title = `<title>${escape("Edit page of the post")}</title>`, ""}<meta name="edit of a single blog page" content="Edit form for the blog post"><!-- HEAD_svelte-zzyrst_END -->`, ""}
