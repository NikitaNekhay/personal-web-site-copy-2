...
const About = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_t();
  return `<p class="short_info svelte-muvav9">${escape($t("IT-Student based in Belarus, Minsk. Part-time making clothes-design, photography, videography. Mainly studies at BSUIR and majoring in Informational systems and technologies in logistics."))}<br></p>


<div class="text-center justify-self-center"><ul class="text-center  svelte-muvav9"><li class="gap-y-10"><p style="margin-block-start: 0px; margin-block-end: 0px;"><a target="_blank" style="text-decoration:none;" class="href_links transition duration-200 hover:text-blue-0" href="https://docs.google.com/document/d/1rcklzYqRFf4ICC1Ai48KPzl5S0NArSxANsda5uv7IdM/edit">CV
                </a></p></li>
        ...
        <li><a class="href_links transition duration-200 hover:text-blue-0" target="_blank" href="https://www.behance.net/nekhaynikita">Phography pieces</a></li></ul>
</div>`;
});
...
<div class="grid-item-content mt-[200px] mb-[420px] svelte-15bm2zp">${validate_component(About, "About").$$render($$result, {}, {}, {})}
